...
console.log(videos)
  return (
    <div className=' bg-black h-screen'>
        ...
        <iframe width="1730" height="719" src={`https://www.youtube.com/embed/${videos[0]?.}`} title={` ${videos[0]?.name}`} frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"></iframe>
