...
function LoginScreen() {
  return (
    <div className='flex flex-col bg-black h-screen bg-[url("https://media-assets-05.thedrum.com/cache/images/thedrum-prod/s3-news-tmp-10557-netflixa--default--1280.jpg")]/ bg-cover bg-no-repeat bg-center  '>
