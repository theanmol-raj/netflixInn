...
function Banner() {
  ...
  return (
    ...
    backgroundImage: ` url('${base_url+movies?.backdrop_path}') `
      ...
      <div className="h-[650px] absolute  w-full bg-gradient-to-t from-black via-transparent to-transparent " />
      <div className=" h-[650px]  relative text-white object-contain max-w-[100rem] mx-auto">
